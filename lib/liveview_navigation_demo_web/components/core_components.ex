defmodule LiveviewNavigationDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewNavigationDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewNavigationDemoWeb.Gettext, "errors", msg, opts)
    end
  end
